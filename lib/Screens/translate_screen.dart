...
class TranslateScreen extends StatefulWidget {
  @override
  _TranslateScreenState createState() {
    return _TranslateScreenState();
  }
}
...
class _TranslateScreenState extends State<TranslateScreen> {
  ...
  List<Map> _myLanguages = [
    {'id': '1', 'image': 'icons/flags/png/fr.png', 'name': "Français"},
    {'id': '2', 'image': 'icons/flags/png/gb.png', 'name': "Anglais"},
  ];
  String _currentLang;
                          ...
                          child: Expanded(
                            ...
                            child: ButtonTheme(
                              ...
                              child: DropdownButton(
                                ...
                                items: _myLanguages.map((LanguageItem) {
                                        ...
                                        children: [
                                          Container(
                                            child: Padding(
                                              ...
                                              child:new Image.asset(LanguageItem['image'], package: 'country_icons',width: 30,height: 30,),
                                            ),
                                            decoration: BoxDecoration(
                                                borderRadius:
